...
$priorities = ['T_Macchine.Codice', 'Q_Clienti.Ragione_Sociale', 'T_DettContratti.ID'];
 ...
 $query = "SELECT TOP (150*$perc) 
            T_Macchine.Codice,T_Macchine.CodModello,T_Macchine.FlagMagazzino, Q_Clienti.Ragione_Sociale ,Q_Clienti.Telefono, Q_Clienti.Indirizzo,Q_Clienti.CAP,Q_Clienti.Localita,
                                                     T_TestContratti.Codice AS NomeContratto, T_DettContratti.FlagAttivo          
             FROM T_Macchine 
            ...
            LEFT JOIN Q_Clienti ON T_TestContratti.CodCliente=Q_Clienti.Codice_Anagrafica
             ...
             AND   IsNull('NomeContratto','') LIKE '$contratti' AND  IsNull(Q_Clienti.Ragione_Sociale,'') LIKE '$cliente'
...
<td class=\"tabMacchina\">".$arr['FlagMagazzino']."</td>
...
<td  class='tabContratto'><a href='../Contratti/index.php?extCodContratti=" . $arr['NomeContratto'] . "'>".$arr['NomeContratto']."</a></td>
<td class='tabContratto'>".$arr['FlagAttivo']."</td>";
